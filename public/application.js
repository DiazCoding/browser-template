...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://git.heroku.com/my-pc-part-list.git',
...
var onAddItemsUsers = function onAddItemsUsers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.addNewItemsUsers(data).done(ui.success).fail(ui.fail);
};

var onGetItemsUsers = function onGetItemsUsers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.getItemsUsers(data).done(function (data) {
    $.each(data.items_users, function (index, element) {
...
var onDeleteItemsUsers = function onDeleteItemsUsers(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  debugger;
  api.destroyItemsUsers(data.items_users.id).then(ui.success).catch(ui.failure);
};
...
var getItemsUsers = function getItemsUsers() {
...
var addNewItemsUsers = function addNewItemsUsers() {
  return $.ajax({
    url: config.apiUrl + '/items_users',
    methond: 'POST'
  });
...
var destroyItemsUsers = function destroyItemsUsers(data) {
  console.log(data);
  return $.ajax({
...
var CreateItemsUsers = function CreateItemsUsers(data) {
  return $.ajax({
    method: 'POST',
...
module.exports = {
  ...
  CreateItemsUsers: CreateItemsUsers,
  addNewItemsUsers: addNewItemsUsers,
  destroyItemsUsers: destroyItemsUsers
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = {
  ...
  getItemsUsersSuccess: getItemsUsersSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
